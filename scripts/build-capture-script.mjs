...
const helperRegex =
  /\b__(name|pow|publicField|privateAdd|privateGet|privateSet|require|defProp|copyProps|toESM|toCommonJS)\b/;
...
const generated =
  ...
  JSON.stringify(captureScriptText) +
  ";\n";

writeFileSync(OUT, generated);
console.log(
  `[build-capture-script] wrote ${OUT} (${generated.length} bytes; bundle ${captureScriptText.length} chars)`,
);
