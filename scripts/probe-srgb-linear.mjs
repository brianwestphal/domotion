...
await page.setContent(
  `<div id=a style="background: color-mix(in srgb-linear, red, blue);">x</div><div id=b style="color:#1e293b;background: color-mix(in srgb, currentColor 10%, transparent);">y</div>`,
);
