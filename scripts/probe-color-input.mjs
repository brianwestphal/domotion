...
console.log(
  "  rect:",
  data.color.rect.top.toFixed(1),
  data.color.rect.left.toFixed(1),
  "w=" + data.color.rect.width,
  "h=" + data.color.rect.height,
);
...
console.log(
  "  rect:",
  data.file.rect.top.toFixed(1),
  data.file.rect.left.toFixed(1),
  "w=" + data.file.rect.width,
  "h=" + data.file.rect.height,
);
