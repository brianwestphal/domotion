...
export const LOGICAL_CLASSIFICATIONS = {
  "logical-defect": {
    ...
    description:
      "Chromium and Domotion disagree before rasterization: routing, shaping, layout, geometry, or another logical-stage decision.",
  },
  "paint-compositing": {
  ...
  unsupported: {
    ...
    description:
      "The fixture exercises behavior outside Domotion's current rendering contract and needs an explicit support decision.",
  },
  "accepted-rasterization": {
    label: "Accepted rasterization-only variance",
    ticketPrefix: "rasterization",
    description:
      "Logical output agrees and the remaining pixels are attributable only to the documented rasterization, hinting, or antialiasing floor.",
  },
} as const;
