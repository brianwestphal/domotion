...
import { captureBrokenImageFallbackFacts, classifyBrokenImageDisposition } from "./broken-image-fallback.js";
...
describe("Chromium broken-image fallback disposition (DM-2463)", () => {
  ...
  it("fails closed to a classified terminal surface when live correlation is absent", async () => {
    ...
    await captureBrokenImageFallbackFacts({} as never, [image], { x: 0, y: 0, width: 100, height: 100 }, warnings);
