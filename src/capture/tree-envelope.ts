...
function preferenceSignature(record: CapturedSessionGenericFamilies): string {
  return JSON.stringify({
    ...
    byScript: Object.entries(record.byScript)
      ...
      .map(([script, families]) => [script, Object.entries(families).sort(([a], [b]) => a.localeCompare(b))]),
  });
}
 ...
 */
export function capturedTreeSessionGenericFamilies(input: CapturedTreeInput): CapturedSessionGenericFamilies | null {
