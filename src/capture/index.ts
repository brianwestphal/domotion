  ...
  try {
    ...
    for (const target of screenshotTargets) {
      ...
      try {
        ...
        if (outputQuad == null || outputBounds == null) continue;
        ...
        if (unclippedQuad == null || unclippedBounds == null) continue;
