...
export const isUnresolvedSvgCssExpression = (value) => value != null && UNRESOLVED_CSS_EXPRESSION.test(value);

export const isConcreteSvgAttributeValue = (value) => value != null && !isUnresolvedSvgCssExpression(value);
