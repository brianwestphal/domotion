  ...
  const captureResizeHandle = (el, cs, tag, rect) => {
    ...
    const custom = blinkUsesCustomResizer(true, isScrollContainer, pseudo.matched)
      ? {
          ...
          backgroundColor: pseudo.backgroundColor ? normColor(pseudo.backgroundColor) : undefined,
