...
export const createFormControlsHandler = ({
  ...
  const captureFormControls = (el, cs, tag) => {
    ...
    const out = {
      ...
      disabled:
        tag === "input" || tag === "button" || tag === "select" || tag === "textarea" ? !!el.disabled : undefined,
      ...
      selectChevron:
        tag === "select" && el.size <= 1 && !el.multiple && cs.appearance !== "none" && cs.webkitAppearance !== "none",
      selectChevronColor:
        tag === "select" && el.size <= 1 && !el.multiple && cs.appearance !== "none" && cs.webkitAppearance !== "none"
      ...
      selectListboxOptions:
        tag === "select" && (el.size > 1 || el.multiple)
          ...
          : undefined,
      accentColor:
        tag === "input" || tag === "progress" || tag === "meter" ? normColor(cs.accentColor || "auto") : undefined,
      ...
      inputFileName:
        tag === "input" && el.type === "file" && el.files && el.files.length > 0 ? el.files[0].name : undefined,
    };
    ...
    if (tag === "progress") {
      ...
      out.progressBarBgImage =
        bar.matched && bar.backgroundImage !== "" ? gradientImage(bar.backgroundImage) : undefined;
      ...
      out.progressValueBgImage =
        val.matched && val.backgroundImage !== "" ? gradientImage(val.backgroundImage) : undefined;
    ...
    if (tag === "meter") {
      ...
      out.meterOptimumBgImage =
        opt.matched && opt.backgroundImage !== "" ? gradientImage(opt.backgroundImage) : undefined;
      out.meterSuboptimumBg = sub.matched && sub.backgroundColor !== "" ? normColor(sub.backgroundColor) : undefined;
      out.meterSuboptimumBgImage =
        sub.matched && sub.backgroundImage !== "" ? gradientImage(sub.backgroundImage) : undefined;
      out.meterEvenLessGoodBg = elg.matched && elg.backgroundColor !== "" ? normColor(elg.backgroundColor) : undefined;
      out.meterEvenLessGoodBgImage =
        elg.matched && elg.backgroundImage !== "" ? gradientImage(elg.backgroundImage) : undefined;
    }
    ...
    if (tag === "input" && el.type === "color") {
      ...
      out.colorSwatchBg =
        swatch.matched && swatch.backgroundColor !== "" ? normColor(swatch.backgroundColor) : undefined;
      out.colorSwatchBgImage =
        swatch.matched && swatch.backgroundImage !== "" ? gradientImage(swatch.backgroundImage) : undefined;
    ...
    if (tag === "input" && el.type === "number") {
      ...
      out.numberSpinButtonBg =
        spin.matched && spin.backgroundColor !== "" ? normColor(spin.backgroundColor) : undefined;
    ...
    if (tag === "input" && el.type === "search") {
      ...
      out.searchCancelButtonBg =
        cancel.matched && cancel.backgroundColor !== "" ? normColor(cancel.backgroundColor) : undefined;
