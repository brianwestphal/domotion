...
const BASE_STYLES = {
  ...
  borderLeftWidth: "8px",
  borderTopColor: "rgb(248,81,73)",
  borderRightColor: "rgb(210,153,34)",
  borderBottomColor: "rgb(139,148,158)",
  borderLeftColor: "rgb(88,166,255)",
...
describe("square mixed dashed/dotted border joints (DM-2429)", () => {
  it.each([
    ...
    [
      "top dashed beside wider left/right",
      { borderTopStyle: "dashed", borderLeftWidth: "12px", borderRightWidth: "10px" },
      "rgb(248,81,73)",
      'x1="10" y1="22" x2="110" y2="22"',
    ],
    [
      "bottom dashed with missing neighbors",
      { borderBottomStyle: "dashed", borderLeftStyle: "none", borderRightStyle: "none" },
      "rgb(139,148,158)",
      'x1="10" y1="77" x2="110" y2="77"',
    ],
