...
// Public-API re-exports kept here for backward compatibility — `src/index.ts`
// barrel imports them through this file. Internal consumers should prefer
// importing from `../capture/embed.js` / `../capture/warnings.js` directly.
