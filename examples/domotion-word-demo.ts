...
function word(text: string, o: SpanOpts): string {
  return (
    `<span style="font-family:${o.font};font-size:${o.size}px;font-weight:${o.weight ?? 900};` +
...
export const VARIANTS: Variant[] = [
  // 1) DOMotation — block Impact + cursive script lockup
  {
    ...
    inner:
      word("DOM", {
        ...
        ls: -2,
        color: "#ff10f0",
        glow: "3px 3px 0 #00ffff,6px 6px 0 #b300ff",
      }) +
      word("otation", {
        font: "'Brush Script MT','Snell Roundhand',cursive",
        size: 96,
        weight: 400,
        style: "italic",
        color: "#fff700",
  ...
  // 2) doMotion — clean dual-color sans, neon glow
  {
    duration: FAST,
    inner:
      word("do", { font: "'Avenir Next',Futura,sans-serif", size: 110, ls: -3, color: "#00ffff", glow: CYAN }) +
  ...
  // 3) DoMotion — slanted neon chalk
  {
    duration: FAST,
    inner:
      `<div style="transform:rotate(-4deg) skewX(-8deg);">` +
      word("DoMotion", {
        font: "Chalkduster,'Marker Felt','Comic Sans MS',cursive",
        size: 100,
        weight: 700,
        color: "#39ff14",
        glow: "4px 4px 0 #ff00ff,8px 8px 0 rgba(255,0,255,0.35)",
      }) +
      `</div>`,
  },
  ...
  // 4) domotion — lowercase rainbow gradient
  {
    ...
    inner: grad("domotion", {
      ...
      size: 116,
      ls: 2,
      gradient: "linear-gradient(90deg,#ff10f0 0%,#ff8c00 25%,#fff700 50%,#39ff14 75%,#00ffff 100%)",
    }),
  },
  ...
  // 5) doMOTION — tiny "do" + huge "MOTION", chromatic aberration
  {
    ...
    inner:
      ...
      word("MOTION", {
        ...
        ls: -4,
        color: "#ff10f0",
        glow: "-5px 0 0 #00ffff,5px 0 0 #fff700",
      }),
  },
  ...
  // 6) DOMOTION — tight all-caps, vertical cyan→magenta gradient
  {
    ...
    inner: grad("DOMOTION", {
      ...
      size: 92,
      ls: -2,
      gradient: "linear-gradient(180deg,#00ffff 0%,#ff00ff 100%)",
      extra: "text-shadow:0 0 18px rgba(255,0,255,0.5);",
    }),
  },
  ...
  // 8) Domotion — elegant thin Didot, soft pink glow
  {
    duration: FAST,
    inner: word("Domotion", {
      font: "Didot,'Bodoni 72','Times New Roman',serif",
      size: 104,
      weight: 400,
      ls: 1,
      color: "#ff5ad6",
      glow: "0 0 10px #ff7bd5,0 0 22px #d000ff",
    }),
  },
  ...
  // 9) DOMOTION — gold letterpress Copperplate
  {
    ...
    inner: grad("DOMOTION", {
      ...
      weight: 700,
      ls: 3,
      gradient: "linear-gradient(180deg,#fff1a8 0%,#ffcf40 45%,#ff8c00 100%)",
      extra: "text-shadow:2px 2px 0 #7a3b00,3px 3px 0 rgba(0,0,0,0.4);",
    }),
  },
  ...
  // 10) doMotion — italic serif, magenta→purple
  {
    ...
    inner: grad("doMotion", {
      ...
      weight: 700,
      style: "italic",
      gradient: "linear-gradient(90deg,#ff2bd6 0%,#7b2ff7 100%)",
      extra: "text-shadow:0 0 16px rgba(180,0,255,0.6);",
    }),
  },
  ...
  // 11) domotion — electric-blue, wide tracking, layered glow
  {
    duration: FAST,
    inner: word("domotion", {
      font: "'Gill Sans','Helvetica Neue',sans-serif",
      size: 92,
      weight: 600,
      ls: 10,
      color: "#2b8fff",
      glow: "0 0 4px #7df9ff,0 0 12px #00b3ff,0 0 28px #0066ff",
    }),
  },
  ...
  {
    duration: FAST,
    inner: word("DOMotation", {
      font: "'Brush Script MT','Snell Roundhand',cursive",
      size: 96,
      weight: 400,
      style: "italic",
      color: "#ff4fd8",
      glow: "0 0 10px #ff10f0,0 0 24px #ff00aa,0 0 44px #ff00ff",
    }),
  },
  ...
  // 13) dOmOtIoN — typewriter, alternating cyan/orange pairs with hard shadow
  {
    ...
    inner:
      word("dO", {
        font: "'American Typewriter',Courier,monospace",
        size: 96,
        weight: 700,
        color: "#00ffd5",
        glow: "3px 3px 0 #003b33",
      }) +
      word("mO", {
        font: "'American Typewriter',Courier,monospace",
        size: 96,
  ...
  // 14) doMOTION — sunset gradient on MOTION, small do
  {
    ...
    inner:
      ...
      grad("MOTION", {
        ...
        size: 118,
        ls: -3,
        gradient: "linear-gradient(180deg,#ffd000 0%,#ff5e9c 50%,#7b2ff7 100%)",
      }),
  },
  ...
  // 15) domotion — ultralight, super-wide tracking, minimal synth
  {
    ...
    inner: word("domotion", {
      ...
      ls: 18,
      color: "#19c0e0",
      glow: "0 0 6px #00ffff,0 0 16px #00cfff",
    }),
  },
  ...
  // 16) DoMotion — marker-felt sticker, stacked hard shadows
  {
    duration: FAST,
    inner: word("DoMotion", {
      font: "'Marker Felt','Comic Sans MS',cursive",
      size: 98,
      weight: 700,
      color: "#fff700",
      glow: "2px 2px 0 #ff10f0,4px 4px 0 #00ffff,6px 6px 0 rgba(0,0,0,0.4)",
    }),
  },
  ...
  // 17) DOMOTION — 3D extrude, magenta with cyan depth
  {
    ...
    inner: word("DOMOTION", {
      ...
      ls: -2,
      color: "#ff2bd6",
      glow: "2px 2px 0 #00d9ff,4px 4px 0 #00d9ff,6px 6px 0 #007a8c,8px 8px 0 #004a55",
    }),
  },
  ...
  // 18) domotion — serif teal→pink
  {
    ...
    inner: grad("domotion", {
      ...
      weight: 700,
      style: "italic",
      gradient: "linear-gradient(90deg,#00ffc8 0%,#ff5ec7 100%)",
      extra: "text-shadow:0 0 14px rgba(0,255,200,0.4);",
    }),
  },
  ...
  // 20) DOMOTION — grand finale: huge rainbow + outer glow
  {
    ...
    inner: grad("DOMOTION", {
      ...
      size: 104,
      ls: -2,
      gradient: "linear-gradient(90deg,#ff10f0,#ff8c00,#fff700,#39ff14,#00ffff,#ff10f0)",
      extra: "text-shadow:0 0 22px rgba(255,255,255,0.55);",
    }),
  },
];
