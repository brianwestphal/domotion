...
async function capture(
  ...
  html: string,
  prefix: string,
): Promise<{ tree: Awaited<ReturnType<typeof captureElementTree>>; svg: string }> {
...
const CF_A = scene({
  ...
  chip: "Crossfade",
  accent: "#7c9cff",
  body: `<div class="h">Revenue</div><div class="sub">This month</div>
...
const CF_B = scene({
  ...
  chip: "Crossfade",
  accent: "#c4a3ff",
  body: `<div class="h">Signups</div><div class="sub">This month</div>
...
const PL_B = scene({
  ...
  chip: "Push left",
  accent: "#fbbf24",
  body: `<div class="h">Deploy is green</div><div class="sub">Ada Lovelace · 2m ago</div>
...
const SC_A = scene({
  ...
  chip: "Scroll",
  accent: "#7c9cff",
  body: `<div class="h">Acme Cloud</div><div class="sub">Ship faster, scale calmly.</div>
...
const WP_A = scene({
  ...
  chip: "Wipe",
  accent: "#7c9cff",
  body: `<div class="h">Before</div><div class="sub">Draft copy</div>
...
const WP_B = scene({
  ...
  chip: "Wipe",
  accent: "#c4a3ff",
  body: `<div class="h">After</div><div class="sub">Shipped copy</div>
...
const IR_A = scene({
  ...
  chip: "Iris",
  accent: "#5eead4",
  body: `<div class="h">Focus</div><div class="big">1</div><div class="sub">One thing at a time.</div>`,
});
const IR_B = scene({
  bg: GREEN,
  chip: "Iris",
  accent: "#4ade80",
  body: `<div class="h">Reveal</div><div class="big">2</div><div class="sub">Then the next.</div>`,
});
...
const ZM_A = scene({
  ...
  chip: "Zoom in",
  accent: "#fbbf24",
  body: `<div class="h">Overview</div><div class="sub">The whole board</div>
...
const ZM_B = scene({
  ...
  chip: "Zoom in",
  accent: "#7c9cff",
  body: `<div class="h">Detail</div><div class="sub">One project</div>
...
const SH_A = scene({
  ...
  chip: "Shine",
  accent: "#c4a3ff",
  body: `<div class="h">Unlock</div><div class="sub">Pro plan</div>
...
const SH_B = scene({
  ...
  chip: "Shine",
  accent: "#5eead4",
  body: `<div class="h">Unlocked</div><div class="sub">Pro plan</div>
...
type TransitionType =
  "crossfade" | "push-left" | "scroll" | "magic-move" | "wipe" | "iris" | "zoom-in" | "shine" | "wipe-clock";
...
async function buildEffects(pg: Page): Promise<void> {
  ...
  const html = scene({
    ...
    chip: "Effects",
    accent: "#7c9cff",
    body: `<div class="h">Spring + Shine</div><div class="sub">DM-1542</div>
