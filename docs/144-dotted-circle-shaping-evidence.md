...
platforms: ["linux"]
tickets: ["DM-2522"]
code: ["src/capture/script/dotted-circle-detect.ts","src/capture/script/dotted-circle-detect.test.ts","src/capture/script/walker/text-segments.ts","src/render/text-to-path.ts"]
