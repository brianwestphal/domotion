...
| `pagedCaptureBundleManifestSchema` / `parsePagedCaptureBundleManifest` | schema / function | Strict version-1 authenticated/unavailable paged-capture manifest contract. Runtime validation rejects source/helper drift, PDF-derived logical claims, unknown fields, nonconsecutive pages, nondeterministic relative SVG paths, and bundle digest drift. See `docs/255-paged-media-capture-bundle.md`. |
