...
tickets: ["DM-1022","DM-1028","DM-2161","DM-2192","DM-227","DM-228","DM-229","DM-2355","DM-2365","DM-2366","DM-2367","DM-2368","DM-237","DM-2380","DM-2419","DM-2453","DM-2455","DM-2465","DM-2477","DM-2478","DM-2479","DM-2480","DM-2488","DM-2491","DM-2520","DM-258","DM-259","DM-260","DM-2615","DM-262","DM-2623","DM-2626","DM-2627","DM-2628","DM-2632","DM-2634","DM-2640","DM-300","DM-457","DM-462","DM-984","DM-987","SK-1093","SK-1097","SK-1099","SK-1100","SK-1101","SK-1105","SK-1108","SK-1111","SK-1113","SK-1114","SK-1115","SK-466","SK-468"]
...
- [x] Font families: generic keywords (`serif`/`sans-serif`/`monospace`/`cursive`) and installed family names resolve through shipped platform-specific selection on macOS, Linux, and Windows. macOS uses its calibrated CoreText/static chain; Linux mirrors Blink's fontconfig-backed family/style match plus live per-codepoint fallback; Windows mirrors DirectWrite family/style selection plus live fallback. Generated per-Unicode-block routing remains the deterministic net beneath the live resolvers, and unmatched stacks reach each platform's calibrated terminal family rather than a macOS-only default. Ongoing CI work hardens the corpus; Linux/Windows family mapping itself is not future work. See [docs 03](03-font-family-chain.md), [40](40-cross-platform-font-paths.md), and [42](42-cross-platform-fallback-calibration.md).
...
- [x] Linux embedded-font target strikes: six exact, evidence-owned tuples preserve design-space x/linear advances while taking FreeType's concrete 26.6-grid y, then use `geometricPrecision` to prevent a second custom-webfont hinting pass: `WenQuanYiZenHeiMono` 17/400 and 26/700, `WenQuanYiZenHei` 32/700, and `LiberationSans` / `FreeSans` / `FreeSerif` 32/400. Admission is per tuple and fixture, never family-wide; WQY UI 32/400 remains outside the allowlist. The SVG stays self-contained—this is neither native font fallback nor system-font passthrough. See [doc 99](99-hinted-embedded-subset.md#linux-exact-target-strike-exceptions-dm-2623--dm-2626--dm-2627).
...
- [x] writing-mode: vertical-rl/vertical-lr/sideways-* — upright + rotated vertical runs, text-combine-upright, and source-transcribed text-decoration geometry. Decorations reuse the horizontal Blink metrics/style/snap/skip-ink emitter in line-relative space before the existing physical transform. Central-baseline side resolution is locale-script-owned (Kana/Hangul versus other scripts), an over result flips underline/overline with distinct em-edge offsets, sideways typography stays alphabetic, and inherited declarations resolve against the target vertical UsedFont. The 26-row exact logical gate plus 16 live Chromium DPR-1/4 side rows change no raster tolerance. See `02-writing-mode.md` and [doc 207](207-cross-platform-decoration-geometry.md).
- [x] Color-bitmap glyph activation (emoji, author color symbols, etc.): rasterized via Playwright `page.screenshot` and embedded as `<image>`. Blink's pinned whole-sequence grammar drives presentation priority; VS15/VS16 and `font-variant-emoji` follow the real declared-family/fallback walk. The selected shaped glyph's physical sbix/COLR/CBDT/SVG representation—not a codepoint range, font name, or pixel-color probe—owns the raster boundary. Palette selection within an already selected COLR glyph is separately source-audited and currently [has a known palette-blind screenshot-cache identity gap](202-font-palette-selection-raster-boundary.md); the activation boundary itself remains exact. See [145-renderer-owned-color-glyph-boundary.md](145-renderer-owned-color-glyph-boundary.md).
