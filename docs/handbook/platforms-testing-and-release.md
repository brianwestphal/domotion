...
| Release | [Visual CI](../66-ci-visual-tests.md), [release parity gate](../138-parity-release-gate.md), [Linux arm64](../196-linux-arm64-release-parity.md), [helper acquisition](../50-glyph-helper-acquisition.md), [paged capture](../259-paged-capture-release-gate.md) | clean-checkout source materializer, primary-host validation, deterministic helper fan-in, paged six-report adjudication, release/check scripts, retained artifacts |
