...
| Paged vector paint | [Authenticated page records](../256-paged-page-print-record.md), [per-page SVG](../257-authenticated-paged-page-svg.md) | pinned Chromium/Skia deltas, `paged-page-record.ts`, `paged-page-svg.ts`, and native smoke evidence |
