...
| Scroll composition | [Chunk diff](../34-scroll-mode-per-chunk-diff.md), [sticky](../35-scroll-sticky-hoisting.md), [grammar](../37-scroll-pattern-grammar.md), [inner live capture](../147-inner-live-scroll-capture.md) | `src/scroll/`, scroll executor/composer tests |
...
| Fragmentation | [Generated pseudo fragments](../176-source-owned-pseudo-fragment-capture.md), [collapsed tables](../225-fragmented-collapsed-table-ownership.md), [paged tables](../230-paged-table-private-fragment-transport.md), [authenticated page records](../256-paged-page-print-record.md), [per-page SVG](../257-authenticated-paged-page-svg.md), [paged API/CLI](../258-paged-capture-api-cli.md), [paged release gate](../259-paged-capture-release-gate.md) | fragment capture/render modules, `paged-page-record.ts`, `paged-page-svg.ts`, `paged-capture.ts`, and exact table/release matrix tests |
