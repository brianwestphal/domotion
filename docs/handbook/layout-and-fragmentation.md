...
tickets: ["DM-2596"]
code: ["src/capture/geometry.ts","src/render/tree.ts","src/scroll/","tests/feature-coverage.ts"]
...
| --- | --- | --- |
| Transforms and culling | [CSS transforms](../06-css-transforms.md), [geometry oracle](../131-transform-geometry-oracle.md), [culling](../33-element-out-of-viewbox-hiding.md) | `src/capture/geometry.ts`, `src/render/transform.ts`, transform oracle tests |
