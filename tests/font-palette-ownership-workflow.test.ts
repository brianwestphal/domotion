...
describe("DM-2510 cross-platform font-palette paint workflow", () => {
  it("runs the pinned strict COLRv0/COLRv1 paint gate on all three operating systems", () => {
    ...
    expect(workflow).toContain("Run strict source-owned DPR1/2 COLRv0/COLRv1 paint gate");
