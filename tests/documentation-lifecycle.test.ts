...
import { completedCanonicalDeclaration, lifecycleConsistencyErrors } from "../scripts/documentation-lifecycle.mjs";
...
describe("documentation lifecycle consistency (DM-2633)", () => {
  ...
  it("rejects the older opening-ticket shipped declaration used by doc 116", () => {
    ...
    expect(completedCanonicalDeclaration(body)).toBe("DM-2070 ships the foundation proposed in doc 115.");
