...
(`packages/text-engine/tools/macos-glyph-extractor`) and the Linux FreeType helper
...
```powershell
pwsh packages/text-engine/tools/win32-glyph-extractor/build.ps1   # → packages/text-engine/tools/win32-glyph-extractor/domotion-glyph-paths.exe
```
