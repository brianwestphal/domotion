...
#
#   pwsh packages/text-engine/tools/win32-glyph-extractor/build.ps1
#
...
#
# Output: packages/text-engine/tools/win32-glyph-extractor/domotion-glyph-paths.exe (statically
