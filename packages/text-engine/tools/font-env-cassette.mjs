 ...
 *   DOMOTION_HELPER_PATH=$PWD/packages/text-engine/tools/font-env-cassette.mjs \
 *   FONT_CASSETTE=cassettes/darwin.json FONT_CASSETTE_MODE=record \
 *   FONT_CASSETTE_REAL=packages/text-engine/tools/macos-glyph-extractor/domotion-glyph-paths \
