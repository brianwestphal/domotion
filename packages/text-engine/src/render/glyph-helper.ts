 ...
 * `fcfallback` comment in `packages/text-engine/tools/linux-glyph-extractor/src/main.cpp`.
 */
 ...
 * `packages/text-engine/tools/linux-glyph-extractor/src/main.cpp`); this is the Node side of the call.
 *
