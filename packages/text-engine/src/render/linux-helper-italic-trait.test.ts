...
const source = readFileSync(resolve("packages/text-engine/tools/linux-glyph-extractor/src/main.cpp"), "utf8");
const winSource = readFileSync(resolve("packages/text-engine/tools/win32-glyph-extractor/src/main.cpp"), "utf8");
