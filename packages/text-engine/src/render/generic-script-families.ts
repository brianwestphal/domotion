...
const SCRIPT_NAME_TO_CODE: ReadonlyMap<string, ScriptCode> = new Map(
  Object.entries({
    zyyy: "COMMON",
    qaai: "INHERITED",
    arab: "ARABIC",
    ...
    hang: "HANGUL",
    hebr: "HEBREW",
    hira: "KATAKANA_OR_HIRAGANA",
    knda: "KANNADA",
    kana: "KATAKANA_OR_HIRAGANA",
    khmr: "KHMER",
    laoo: "LAO",
    latn: "LATIN",
    mlym: "MALAYALAM",
...
const LOCALE_TO_SCRIPT: ReadonlyMap<string, ScriptCode> = new Map(
  Object.entries({
    aa: "LATIN",
    ab: "CYRILLIC",
    ady: "CYRILLIC",
    ...
    nan: "TRADITIONAL_HAN",
    yue: "TRADITIONAL_HAN",
    "zh-cdo": "SIMPLIFIED_HAN",
    "zh-cjy": "SIMPLIFIED_HAN",
    "zh-cmn": "SIMPLIFIED_HAN",
    "zh-cpx": "SIMPLIFIED_HAN",
    "zh-czh": "SIMPLIFIED_HAN",
    "zh-czo": "SIMPLIFIED_HAN",
    "zh-gan": "SIMPLIFIED_HAN",
    "zh-hsn": "SIMPLIFIED_HAN",
    "zh-mnp": "SIMPLIFIED_HAN",
    "zh-wuu": "SIMPLIFIED_HAN",
    "zh-hak": "TRADITIONAL_HAN",
    "zh-lzh": "TRADITIONAL_HAN",
    "zh-nan": "TRADITIONAL_HAN",
    "zh-yue": "TRADITIONAL_HAN",
    "zh-hk": "TRADITIONAL_HAN",
    "zh-mo": "TRADITIONAL_HAN",
    "zh-tw": "TRADITIONAL_HAN",
  }),
);
 ...
 */
export function perScriptGenericFamily(platform: string, lang: string, genericName: string): string | null {
 ...
 */
export function firstAvailableOrFirst(families: string, isAvailable: (family: string) => boolean): string {
  const list = families
    .split(",")
    .map((s) => s.trim())
    .filter((s) => s !== "");
