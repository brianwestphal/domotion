 ...
 * replayed from `packages/text-engine/tests/cassettes/linux-fallback.json`, which carries a
 ...
 * what `packages/text-engine/tools/linux-glyph-extractor/src/main.cpp`'s `runFcFallbackQuery`
