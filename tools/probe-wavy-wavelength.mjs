...
let html =
  '<!doctype html><meta charset="utf-8"><style>body{margin:24px;font-family:system-ui,sans-serif;background:white;color:black;line-height:2;}.s{text-decoration:underline wavy red;}</style>';
for (const s of SAMPLES)
  html += `<div><span class="s" style="font-size:${s.fontSize}px;text-decoration-thickness:${s.thickness}px;">mmmmmmmmmmmmmmmmmmmmmmmmmmmmmm</span></div>`;
