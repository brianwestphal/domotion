...
export const ANIMATED_IMAGE_TRUTH_PROTOCOL = "domotion-animated-image-bytes-v1" as const;
export const ANIMATED_IMAGE_TRUTH_CHROMIUM_REVISION = "7d859f271cbda744098ac69f44978d4edfa62be3" as const;
...
export const ANIMATED_IMAGE_TRUTH_OWNER_SELECTOR_TOKEN = /^[A-Za-z0-9._-]{1,128}$/;
...
export type AnimatedImageTruthDenialCode = (typeof ANIMATED_IMAGE_TRUTH_DENIAL_CODES)[number];
...
export type AnimatedImageTruthProperty = (typeof ANIMATED_IMAGE_TRUTH_PROPERTIES)[number];
...
export type AnimatedImageTruthProbeId = (typeof ANIMATED_IMAGE_TRUTH_PROBES)[number];

export type AnimatedImageTruthExpectedOutcome = "stable-authorized" | "stable-denied" | "reject-drift";
...
export const ANIMATED_IMAGE_TRUTH_CASES: readonly AnimatedImageTruthCaseRequirement[] = Object.freeze([
  { probeId: "img-src-mutation", caseId: "replace-src", expected: "reject-drift", property: "html-current", index: 0 },
  {
    probeId: "img-src-mutation",
    caseId: "stable-animated-webp",
    expected: "stable-authorized",
  ...
  {
    probeId: "picture-srcset-media-dpr-mutation",
    caseId: "source-order",
    expected: "reject-drift",
    property: "html-current",
    index: 0,
  },
  {
  ...
  {
    probeId: "css-image-set-option-reorder",
    caseId: "selected-option",
    expected: "reject-drift",
  ...
  {
    probeId: "css-image-set-option-reorder",
    caseId: "stable-selected-option",
    expected: "stable-authorized",
    property: "background-image",
    index: 0,
  },
  {
    probeId: "css-background-layer-reorder",
    caseId: "layer-zero",
    expected: "reject-drift",
    property: "background-image",
    index: 0,
  ...
  {
    probeId: "css-mask-layer-reorder",
    caseId: "mask-zero",
    expected: "reject-drift",
    property: "mask-image",
    index: 0,
  ...
  {
    probeId: "same-url-competing-requests",
    caseId: "two-img-owners",
    expected: "stable-authorized",
    property: "html-current",
    index: 0,
  },
  {
    probeId: "same-url-memory-cache-sharing",
    caseId: "css-shared",
    expected: "stable-authorized",
    property: "background-image",
    index: 0,
  ...
  {
    probeId: "redirect-response-mime-drift",
    caseId: "redirect-destination",
    expected: "reject-drift",
    property: "html-current",
    index: 0,
  },
  ...
  {
    probeId: "settled-304",
    caseId: "settled-cache-entry",
    expected: "stable-authorized",
    property: "html-current",
    index: 0,
  },
  {
    probeId: "active-revalidation",
    caseId: "in-flight-validator",
    expected: "stable-denied",
    property: "html-current",
    index: 0,
  },
  {
    probeId: "service-worker-router-cache-replacement",
    caseId: "stable-cache-route",
    expected: "stable-authorized",
    property: "html-current",
    index: 0,
  },
  ...
  {
    probeId: "cors-anonymous-success",
    caseId: "anonymous",
    expected: "stable-authorized",
    property: "html-current",
    index: 0,
  ...
  {
    probeId: "cors-credentials-success",
    caseId: "credentials",
    expected: "stable-authorized",
    property: "html-current",
    index: 0,
  ...
  {
    probeId: "paintable-no-cors-denial",
    caseId: "opaque-paintable",
    expected: "stable-denied",
    property: "html-current",
    index: 0,
  },
  {
    probeId: "data-url-mutation",
    caseId: "stable-data",
    expected: "stable-authorized",
    property: "html-current",
    index: 0,
  ...
  {
    probeId: "data-url-mutation",
    caseId: "payload-replacement",
    expected: "reject-drift",
    property: "html-current",
    index: 0,
  },
  {
    probeId: "blob-replacement-revocation",
    caseId: "stable-blob",
    expected: "stable-authorized",
    property: "html-current",
    index: 0,
  ...
  {
    probeId: "blob-replacement-revocation",
    caseId: "revoke-and-replace",
    expected: "reject-drift",
    property: "html-current",
    index: 0,
  },
  {
    probeId: "multipart-rejection",
    caseId: "two-parts",
    expected: "stable-denied",
    property: "html-current",
    index: 0,
  },
  {
    ...
    caseId: "stable-closed-shadow-before",
    expected: "stable-authorized",
    property: "content",
    index: 0,
    pseudoType: "before",
  ...
  {
    probeId: "owner-adoption-detachment",
    caseId: "stable-svg",
    expected: "stable-authorized",
    property: "svg-href",
    index: 0,
  ...
  {
    probeId: "navigation-stale-backend-node",
    caseId: "stable-input",
    expected: "stable-authorized",
    property: "input-src",
    index: 0,
...
export const ANIMATED_IMAGE_TRUTH_PROBE_REQUIREMENTS: readonly AnimatedImageTruthProbeRequirement[] = Object.freeze([
  {
    probeId: "img-src-mutation",
    properties: ["html-current"],
    expected: ["stable-authorized", "reject-drift"],
    sourceReferences: ["third_party/blink/renderer/core/loader/image_loader.cc:595-597,646-723"],
    mutatedFacts: ["selected content pointer", "currentSrc", "request id"],
  },
  {
    probeId: "picture-srcset-media-dpr-mutation",
    properties: ["html-current"],
    expected: ["stable-authorized", "reject-drift"],
    sourceReferences: ["third_party/blink/renderer/core/html/html_image_element.cc:475-514,734-750,1002-1029"],
    mutatedFacts: ["source order", "srcset", "sizes", "media", "DPR", "viewport"],
  },
  {
    probeId: "css-image-set-option-reorder",
    ...
    expected: ["stable-authorized", "reject-drift"],
    sourceReferences: [
      "third_party/blink/renderer/core/css/css_image_set_value.cc:46-105,118-122",
      "third_party/blink/renderer/core/css/resolver/element_style_resources.cc:417-500",
    ],
    mutatedFacts: ["selected StyleImage", "selected image-set option index"],
  },
  {
    probeId: "css-background-layer-reorder",
    properties: ["background-image", "border-image-source"],
    expected: ["stable-authorized", "reject-drift"],
    sourceReferences: ["third_party/blink/renderer/core/css/resolver/element_style_resources.cc:417-500"],
    mutatedFacts: ["ordered background layer", "selected content pointer"],
  },
  {
    probeId: "css-mask-layer-reorder",
    properties: ["mask-image"],
    expected: ["stable-authorized", "reject-drift"],
    sourceReferences: ["third_party/blink/renderer/core/css/resolver/element_style_resources.cc:491-500"],
    mutatedFacts: ["ordered mask layer", "anonymous-CORS selection"],
  },
  {
    probeId: "generated-content-item-reorder",
    properties: ["content"],
    expected: ["stable-authorized", "reject-drift"],
    sourceReferences: [
      "third_party/blink/renderer/core/css/properties/longhands/longhands_custom.cc:3267-3291",
      "third_party/blink/renderer/core/style/content_data.h:108-166",
    ],
    mutatedFacts: ["pseudo identity", "ordered ContentData item"],
  },
  {
    probeId: "same-url-competing-requests",
    properties: ["html-current", "background-image"],
    expected: ["stable-authorized", "stable-denied"],
    sourceReferences: ["third_party/blink/renderer/platform/loader/fetch/resource_fetcher.cc:1655-1660"],
    mutatedFacts: ["exact Resource pointer", "inspector request id"],
  },
  {
    probeId: "same-url-memory-cache-sharing",
    properties: ["background-image", "list-style-image"],
    expected: ["stable-authorized", "stable-denied"],
    sourceReferences: [
      "third_party/blink/renderer/core/css/style_image_cache.cc:24-37",
      "third_party/blink/renderer/platform/loader/fetch/resource_fetcher.cc:1655-1660",
    ],
    mutatedFacts: ["shared content pointer", "memory-cache request relation"],
  },
  {
    probeId: "redirect-response-mime-drift",
    properties: ["html-current"],
    expected: ["stable-authorized", "reject-drift"],
    sourceReferences: [
      "third_party/blink/renderer/platform/loader/fetch/resource.cc:573-605",
      "third_party/blink/renderer/platform/loader/fetch/resource_response.h:99-130",
    ],
    mutatedFacts: ["redirect hops", "status", "response URL", "MIME", "body SHA"],
  },
  {
    probeId: "settled-304",
    properties: ["html-current"],
    expected: ["stable-authorized"],
    sourceReferences: [
      "third_party/blink/renderer/platform/loader/fetch/resource.cc:1032-1055",
      "third_party/blink/renderer/core/inspector/inspector_network_agent.cc:1698-1705",
    ],
    mutatedFacts: ["revalidation count", "last validation status", "retained body"],
  },
  {
    probeId: "active-revalidation",
    properties: ["html-current"],
    expected: ["stable-denied", "reject-drift"],
    sourceReferences: ["third_party/blink/renderer/platform/loader/fetch/resource.cc:1032-1055"],
    mutatedFacts: ["IsCacheValidator", "response sequence"],
  },
  {
    probeId: "service-worker-router-cache-replacement",
    properties: ["html-current"],
    expected: ["stable-authorized", "reject-drift"],
    sourceReferences: [
      "third_party/blink/renderer/platform/loader/fetch/resource_response.cc:137-166",
      "third_party/blink/renderer/platform/loader/fetch/resource_response.h:227-280,648-665",
    ],
    mutatedFacts: ["service-worker source", "router", "URL list", "CacheStorage name"],
  },
  {
    probeId: "cors-anonymous-success",
    properties: ["html-current", "mask-image"],
    expected: ["stable-authorized"],
    sourceReferences: [
      "third_party/blink/renderer/platform/loader/fetch/fetch_parameters.cc:54-87",
      "third_party/blink/renderer/core/loader/resource/image_resource_content.cc:660-664",
    ],
    mutatedFacts: ["request mode", "same-origin credentials", "Fetch response type"],
  },
  {
    probeId: "cors-credentials-success",
    properties: ["html-current"],
    expected: ["stable-authorized"],
    sourceReferences: [
      "third_party/blink/renderer/core/loader/image_loader.cc:337-346",
      "third_party/blink/renderer/platform/loader/fetch/fetch_parameters.cc:54-87",
    ],
    mutatedFacts: ["include credentials", "origin-clean response"],
  },
  {
    probeId: "cors-failure",
    properties: ["html-current", "mask-image"],
    expected: ["stable-denied"],
    sourceReferences: ["third_party/blink/renderer/core/loader/resource/image_resource.cc:689-696"],
    mutatedFacts: ["failed CORS", "body-free denial"],
  },
  {
    probeId: "paintable-no-cors-denial",
    properties: ["html-current", "background-image"],
    expected: ["stable-denied"],
    sourceReferences: [
      "third_party/blink/renderer/core/inspector/inspector_network_agent.cc:2767-2796",
      "third_party/blink/renderer/core/loader/resource/image_resource_content.cc:660-664",
    ],
    mutatedFacts: ["debugger body availability", "corsSameOrigin=false", "discarded body"],
  },
  {
    probeId: "data-url-mutation",
    properties: ["html-current", "background-image"],
    expected: ["stable-authorized", "reject-drift"],
    sourceReferences: ["third_party/blink/renderer/core/loader/resource/image_resource_content.cc:316-319"],
    mutatedFacts: ["selected data URL", "parsed length", "parsed SHA"],
  },
  {
    probeId: "blob-replacement-revocation",
    properties: ["html-current"],
    expected: ["stable-authorized", "stable-denied", "reject-drift"],
    sourceReferences: ["third_party/blink/renderer/core/loader/resource/image_resource_content.cc:316-319"],
    mutatedFacts: ["blob URL", "owning document", "revocation", "double SHA"],
  },
  {
    probeId: "multipart-rejection",
    properties: ["html-current"],
    expected: ["stable-denied"],
    sourceReferences: ["third_party/blink/renderer/core/loader/resource/image_resource.cc:609-618,652-686"],
    mutatedFacts: ["multipart response", "mutable part buffer"],
  },
  {
    probeId: "shadow-pseudo-slot-collision",
    properties: ["content", "background-image"],
    expected: ["stable-authorized", "reject-drift"],
    sourceReferences: [
      "third_party/blink/renderer/core/css/properties/longhands/longhands_custom.cc:3267-3291",
      "third_party/blink/renderer/core/style/content_data.h:108-166",
    ],
    mutatedFacts: ["shadow host chain", "root mode", "pseudo type", "slot index"],
  },
  {
    probeId: "owner-adoption-detachment",
    properties: ["html-current", "svg-href"],
    expected: ["stable-authorized", "stable-denied", "reject-drift"],
    sourceReferences: [
      "third_party/blink/renderer/core/svg/svg_image_element.cc:176-179",
      "third_party/blink/renderer/core/loader/image_loader.cc:595-597,646-723",
    ],
    mutatedFacts: ["connected owner", "document", "content pointer"],
  },
  {
    probeId: "navigation-stale-backend-node",
    properties: ["html-current", "input-src"],
    expected: ["stable-authorized", "stable-denied", "reject-drift"],
    sourceReferences: [
      "third_party/blink/renderer/core/dom/dom_node_ids.cc",
      "third_party/blink/renderer/core/loader/document_loader.cc",
    ],
    mutatedFacts: ["backend node", "document nonce", "loader id", "navigation sequence"],
  },
]);
...
export interface AnimatedImageTruthDocument extends AnimatedImageTruthSafeDocumentIdentity {
  url: string;
  origin: string;
}
...
export interface AnimatedImageTruthOwner extends AnimatedImageTruthSafeOwnerIdentity {
...
export type AnimatedImageTruthRecord = AnimatedImageTruthAuthorizedRecord | AnimatedImageTruthDeniedRecord;
...
export const ANIMATED_IMAGE_TRUTH_LIMITS_FINGERPRINT = animatedImageTruthSha256(ANIMATED_IMAGE_TRUTH_LIMITS);

const schemaKeys = (...keys: string[]): readonly string[] => Object.freeze(keys.sort());
...
const STRICT_REQUEST_KEYS = schemaKeys("ownerSelectorToken", "requestedFrameIndex", "limitsFingerprint");
const SAFE_DOCUMENT_KEYS = schemaKeys("targetId", "frameId", "documentLoaderId", "documentNonce", "navigationSequence");
...
const REDIRECT_KEYS = schemaKeys("requestUrl", "responseUrl", "status", "responseTime");
const RESOURCE_KEYS = schemaKeys(
  ...
  "serviceWorkerRouterSha256",
  "serviceWorkerUrlList",
  "cacheStorageCacheName",
  "responseTime",
  "originalResponseTime",
  "revalidationCount",
  "lastRevalidationStatus",
  "networkEncodedDataLength",
);
const BODY_KEYS = schemaKeys("transport", "base64EncodedByProtocol", "byteLength", "sha256", "networkLoadingFinished");
...
const PROBE_ROW_KEYS = schemaKeys(
  ...
  "publicBody",
  "deniedInspectorBodyDiscarded",
  "activation",
);
const ACTIVATION_KEYS = schemaKeys("sourceReferences", "mutatedFacts", "observedFailure");
const PUBLIC_BODY_KEYS = schemaKeys("transport", "base64EncodedByProtocol", "byteLength", "sha256");
...
const CASES_BY_KEY = new Map(ANIMATED_IMAGE_TRUTH_CASES.map((row) => [`${row.probeId}/${row.caseId}`, row]));
const REQUIREMENTS_BY_PROBE = new Map(ANIMATED_IMAGE_TRUTH_PROBE_REQUIREMENTS.map((row) => [row.probeId, row]));
...
function validateOracleProvenance(value: unknown, label: string, failures: string[]): void {
...
function validateStrictRequest(value: unknown, label: string, failures: string[]): void {
  if (!exactKeys(value, STRICT_REQUEST_KEYS, label, failures)) return;
  if (
    typeof value.ownerSelectorToken !== "string" ||
...
function validateSafeDocument(value: unknown, label: string, failures: string[], authorized: boolean): void {
  if (!exactKeys(value, authorized ? AUTHORIZED_DOCUMENT_KEYS : SAFE_DOCUMENT_KEYS, label, failures)) return;
...
function validateSlot(value: unknown, label: string, failures: string[]): void {
  ...
  if (
    value.imageSetOptionIndex != null &&
...
function validateSafeOwner(value: unknown, label: string, failures: string[], authorized: boolean): void {
  if (!exactKeys(value, authorized ? AUTHORIZED_OWNER_KEYS : SAFE_OWNER_KEYS, label, failures)) return;
  validateSlot(value.slot, `${label}.slot`, failures);
  if (!["html-image", "svg-image", "image-input", "css-image"].includes(value.kind as string)) {
  ...
  if (value.pseudo != null) {
    if (
      exactKeys(value.pseudo, PSEUDO_KEYS, `${label}.pseudo`, failures) &&
      (!Number.isInteger(value.pseudo.backendNodeId) ||
        (value.pseudo.backendNodeId as number) <= 0 ||
        typeof value.pseudo.type !== "string" ||
        value.pseudo.type.length === 0)
    ) {
      failures.push(`${label}: pseudo identity is invalid`);
    }
  }
  if (
    !Array.isArray(value.shadowHostBackendNodeIds) ||
    !Array.isArray(value.shadowRootTypes) ||
    ...
    value.shadowHostBackendNodeIds.some((entry) => !Number.isInteger(entry) || entry <= 0) ||
    value.shadowRootTypes.some((entry) => !["user-agent", "open", "closed"].includes(entry))
  ) {
  ...
  if (authorized) {
    ...
    if (
      typeof value.selectedResourceUrl !== "string" ||
...
function validateRequestIdentity(value: unknown, label: string, failures: string[]): void {
  if (!exactKeys(value, REQUEST_IDENTITY_KEYS, label, failures)) return;
  for (const key of ["inspectorRequestId", "requestLoaderId", "requestFrameId", "requestMode", "credentialsMode"]) {
    if (typeof value[key] !== "string" || (value[key] as string).length === 0) {
      failures.push(`${label}: ${key} missing`);
    }
  }
...
function validateDeniedRecord(value: AnimatedImageTruthDeniedRecord, label: string, failures: string[]): void {
  ...
  if (value.requestIdentity != null)
    validateRequestIdentity(value.requestIdentity, `${label}.requestIdentity`, failures);
...
function validateAuthorizedRecord(value: AnimatedImageTruthAuthorizedRecord, label: string, failures: string[]): void {
  ...
  const resourceIsExact = exactKeys(value.resource, RESOURCE_KEYS, `${label}.resource`, failures);
  const bodyIsExact = exactKeys(value.body, BODY_KEYS, `${label}.body`, failures);
  const epochsAreExact = exactKeys(value.epochs, EPOCH_KEYS, `${label}.epochs`, failures);
  ...
  for (const key of ["responseTime", "originalResponseTime"] as const) {
    if (typeof value.resource[key] !== "number" || !Number.isFinite(value.resource[key])) {
      failures.push(`${label}.resource: ${key} must be finite`);
      resourceTypesAreSafe = false;
    }
  }
  for (const key of ["status", "memoryCacheHitCount", "revalidationCount", "networkEncodedDataLength"] as const) {
    if (!Number.isInteger(value.resource[key])) {
      failures.push(`${label}.resource: ${key} must be an integer`);
      resourceTypesAreSafe = false;
    }
  }
  if (value.resource.lastRevalidationStatus !== null && !Number.isInteger(value.resource.lastRevalidationStatus)) {
  ...
  if (Array.isArray(value.resource.redirects)) {
    value.resource.redirects.forEach((redirect, index) => {
      ...
      if (
        typeof redirect.requestUrl !== "string" ||
  ...
  if (
    !Array.isArray(value.resource.serviceWorkerUrlList) ||
  ...
  if (value.resource.serviceWorkerRouterSha256 !== null) {
    validateSha(value.resource.serviceWorkerRouterSha256, `${label}.resource.serviceWorkerRouterSha256`, failures);
  }
  if (
    !Number.isInteger(value.epochs.resourceResponseSequence) ||
  ...
  if (value.resource.fromServiceWorker && value.resource.serviceWorkerControllerVersionId === null) {
    failures.push(`${label}: service-worker response lacks controller identity`);
  }
  if (value.resource.fromServiceWorker !== (value.resource.serviceWorkerResponseSource !== null)) {
    failures.push(`${label}: service-worker source flag is inconsistent`);
  }
  if (
    !Number.isInteger(value.body.byteLength) ||
  ...
  if (
    !["network-get-response-body", "data-url", "blob-read"].includes(value.body.transport) ||
    typeof value.body.base64EncodedByProtocol !== "boolean" ||
    (value.body.networkLoadingFinished !== true && value.body.networkLoadingFinished !== null)
  ) {
  ...
  const statusIsSuccessful =
    value.body.transport === "network-get-response-body"
      ? value.resource.status >= 200 && value.resource.status < 300
      : value.resource.status === 0 || (value.resource.status >= 200 && value.resource.status < 300);
  if (
    !statusIsSuccessful ||
    value.resource.memoryCacheHitCount < 0 ||
    value.resource.revalidationCount < 0 ||
    (value.resource.lastRevalidationStatus !== null &&
      (value.resource.lastRevalidationStatus < 100 || value.resource.lastRevalidationStatus > 599))
  ) {
    failures.push(`${label}: response/revalidation status is invalid`);
  }
  if (value.body.transport === "network-get-response-body" && value.body.networkLoadingFinished !== true) {
    failures.push(`${label}: HTTP(S) body was retained before loadingFinished`);
  }
  if (
    value.body.transport === "network-get-response-body" &&
    (!value.body.base64EncodedByProtocol || value.resource.networkEncodedDataLength < 0)
  ) {
    failures.push(`${label}: HTTP(S) protocol-body evidence is incomplete`);
  }
  if (value.body.transport !== "network-get-response-body" && value.body.networkLoadingFinished !== null) {
    failures.push(`${label}: data/blob body carries a network completion claim`);
  }
  if (
    value.body.transport !== "network-get-response-body" &&
    (value.body.base64EncodedByProtocol || value.resource.networkEncodedDataLength !== -1)
  ) {
    failures.push(`${label}: data/blob body carries network-only evidence`);
  }
  if (
    value.resource.mimeType === "multipart/x-mixed-replace" ||
...
export function validateAnimatedImageTruthRecord(value: AnimatedImageTruthRecord, label = "record"): string[] {
  ...
  try {
    ...
    if (url.protocol === "blob:") {
      try {
        ...
        const owningOrigin =
          owningUrl.hostname === "127.0.0.1" || owningUrl.hostname === "localhost"
    ...
    const originRole =
      url.hostname === "127.0.0.1" || url.hostname === "localhost" ? `${url.protocol}//loopback` : url.origin;
...
function validateRequiredCaseSemantics(row: AnimatedImageTruthProbeRow, label: string, failures: string[]): void {
  ...
  const requiredOwnerKind =
    required.property === "html-current"
      ? "html-image"
  ...
  if (
    ...
    (retainedOwner.slot.property !== required.property ||
      ...
      (required.pseudoType !== undefined && retainedOwner.pseudo?.type !== required.pseudoType))
  ) {
  ...
  const requireDenial = (code: AnimatedImageTruthDenialCode, message: string): void => {
  ...
  switch (`${row.probeId}/${row.caseId}`) {
    case "img-src-mutation/stable-animated-webp":
      requireAuthorized((record) => record.resource.mimeType === "image/webp", "animated WebP MIME was not observed");
      break;
    case "img-src-mutation/stable-apng":
      requireAuthorized((record) => record.resource.mimeType === "image/png", "APNG MIME was not observed");
      break;
    case "css-image-set-option-reorder/stable-selected-option":
      requireAuthorized(
        (record) => record.owner.slot.imageSetOptionIndex !== null,
    ...
    case "same-url-memory-cache-sharing/list-style":
      requireAuthorized((record) => record.resource.memoryCacheHitCount > 0, "memory-cache sharing was not observed");
      break;
    case "redirect-response-mime-drift/stable-redirect":
      requireAuthorized((record) => record.resource.redirects.length > 0, "redirect chain was not observed");
      break;
    case "settled-304/settled-cache-entry":
      requireAuthorized(
        (record) => record.resource.revalidationCount > 0 && record.resource.lastRevalidationStatus === 304,
        "settled 304 revalidation was not observed",
      );
      break;
    case "active-revalidation/in-flight-validator":
      requireDenial("revalidation-in-flight", "active cache validation was not observed");
      break;
    ...
    case "data-url-mutation/stable-data":
      requireAuthorized((record) => record.body.transport === "data-url", "data URL transport was not observed");
      break;
    case "blob-replacement-revocation/stable-blob":
      requireAuthorized(
        (record) => record.body.transport === "blob-read",
    ...
    case "shadow-pseudo-slot-collision/stable-closed-shadow-before":
      requireAuthorized(
        (record) => record.owner.shadowRootTypes.includes("closed") && record.owner.pseudo?.type === "before",
        "closed-shadow pseudo identity was not observed",
      );
      break;
    case "owner-adoption-detachment/stable-svg":
      requireAuthorized((record) => record.owner.kind === "svg-image", "SVG image owner was not observed");
      break;
    case "navigation-stale-backend-node/stable-input":
      requireAuthorized((record) => record.owner.kind === "image-input", "image input owner was not observed");
      break;
  }
}
...
function normalizedRecord(value: AnimatedImageTruthRecord): unknown {
  ...
  return {
    ...
    resource: {
      ...
      serviceWorkerControllerPresent: value.resource.serviceWorkerControllerVersionId !== null,
...
export function normalizedAnimatedImageTruthRowsSha256(rows: AnimatedImageTruthProbeRow[]): string {
  return animatedImageTruthSha256(
    [...rows]
...
function validateProbeRow(row: AnimatedImageTruthProbeRow, label: string): string[] {
  ...
  const beginIsRecord =
    row.begin != null &&
    typeof row.begin === "object" &&
    (row.begin.outcome === "authorized" || row.begin.outcome === "denied");
  const finishIsRecord =
    row.finish != null &&
    typeof row.finish === "object" &&
  ...
  const requiredCase =
    typeof row.probeId === "string" && typeof row.caseId === "string"
  ...
  if (!exactKeys(row.activation, ACTIVATION_KEYS, `${label}.activation`, failures)) return failures;
  if (
    !Array.isArray(row.activation.sourceReferences) ||
    row.activation.sourceReferences.length === 0 ||
    row.activation.sourceReferences.some((entry) => typeof entry !== "string" || entry.length === 0)
  ) {
    failures.push(`${label}: source references missing`);
  }
  if (
    !Array.isArray(row.activation.mutatedFacts) ||
  ...
  if (
    requirement &&
    (JSON.stringify(row.activation.sourceReferences) !== JSON.stringify(requirement.sourceReferences) ||
      JSON.stringify(row.activation.mutatedFacts) !== JSON.stringify(requirement.mutatedFacts))
  ) {
    failures.push(`${label}: source-linked activation contract drift`);
  }
  if (row.activation.observedFailure != null && !DENIAL_CODES.has(row.activation.observedFailure)) {
    failures.push(`${label}: observed failure is invalid`);
  }
  if (row.publicBody != null) {
    if (exactKeys(row.publicBody, PUBLIC_BODY_KEYS, `${label}.publicBody`, failures)) {
      validateSha(row.publicBody.sha256, `${label}.publicBody.sha256`, failures);
      if (
        !Number.isInteger(row.publicBody.byteLength) ||
  ...
  if (row.expected === "stable-authorized") {
    if (row.begin.outcome !== "authorized" || row.finish.outcome !== "authorized" || !row.transactionUnchanged) {
      ...
      if (row.publicBody == null) failures.push(`${label}: authenticated public body evidence missing`);
        ...
        row.publicBody.byteLength !== row.begin.body.byteLength ||
    ...
    if (row.begin.outcome !== "denied" || row.finish.outcome !== "denied" || !row.transactionUnchanged) {
    ...
    if (!row.deniedInspectorBodyDiscarded)
      failures.push(`${label}: rejected transaction did not discard transient body facts`);
  }
...
function validateBinary(value: unknown, label: string, failures: string[]): value is AnimatedImageTruthBinaryIdentity {
  if (!exactKeys(value, BINARY_KEYS, label, failures)) {
    return false;
  }
  if (
    typeof value.pathToken !== "string" ||
    value.pathToken.length === 0 ||
...
export function adjudicateAnimatedImageOwnerResourceTruth(
  ...
  const expectedKeys = operatingSystems.flatMap((os) => evidenceRoles.map((role) => `${os}/${role}`));
  ...
  for (const [reportIndex, candidate] of reportCandidates.entries()) {
    ...
    if (
      !operatingSystems.includes(candidate.operatingSystem as (typeof operatingSystems)[number]) ||
      !evidenceRoles.includes(candidate.evidenceRole as (typeof evidenceRoles)[number])
    ) {
    ...
    if (
      report.schemaVersion !== ANIMATED_IMAGE_TRUTH_SCHEMA_VERSION ||
      report.ticket !== "DM-2583" ||
      report.stage !== "animated-image-owner-resource-truth"
    ) {
    ...
    if (report.sourceManifestSha256 !== ANIMATED_IMAGE_TRUTH_SOURCE_MANIFEST_SHA256) {
    ...
    if (
      typeof report.buildInvocationId !== "string" ||
      report.buildInvocationId.length === 0 ||
      typeof report.observationId !== "string" ||
      report.observationId.length === 0 ||
      typeof report.browserContextId !== "string" ||
      report.browserContextId.length === 0 ||
      !Number.isInteger(report.browserProcessId) ||
      report.browserProcessId <= 0
    ) {
      failures.push(`${key}: build/process/context provenance incomplete`);
    }
    if (!exactKeys(report.binaries, BINARIES_KEYS, `${key}.binaries`, failures)) continue;
    const browserIsValid = validateBinary(report.binaries.browser, `${key}.browser`, failures);
    const rendererIsValid = validateBinary(report.binaries.renderer, `${key}.renderer`, failures);
    if (browserIsValid && rendererIsValid) {
      if (
        report.binaries.browser.sha256 !== report.binaries.renderer.sha256 ||
      ...
      const expectedExecutableToken = report.operatingSystem === "Windows" ? "headless_shell.exe" : "headless_shell";
      if (
        report.binaries.browser.pathToken !== expectedExecutableToken ||
    ...
    const validLibraries = report.binaries.loadedLibraries.flatMap((binary, index) =>
      validateBinary(binary, `${key}.loadedLibraries[${index}]`, failures) ? [binary] : [],
    );
    const libraryTokens = validLibraries.map((binary) => binary.pathToken.toLowerCase());
    ...
    for (const [rowIndex, rowCandidate] of report.rows.entries()) {
      const rowObject =
        rowCandidate != null && typeof rowCandidate === "object" && !Array.isArray(rowCandidate)
          ? (rowCandidate as unknown as Record<string, unknown>)
          : null;
      const rowKey =
        typeof rowObject?.probeId === "string" && typeof rowObject.caseId === "string"
      ...
      seen.add(rowKey);
      const rowFailures = validateProbeRow(rowCandidate as AnimatedImageTruthProbeRow, `${key}/${rowKey}`);
      ...
      if (row.begin.oracle.patchSha256 !== report.patchSha256 || row.finish.oracle.patchSha256 !== report.patchSha256) {
  ...
  for (const os of ["macOS", "Linux", "Windows"] as const) {
    ...
    if (
      proposal.buildInvocationId === validation.buildInvocationId ||
    ...
    if (
      proposal.patchSha256 !== validation.patchSha256 ||
    ...
    if (
      proposal.architecture !== validation.architecture ||
  ...
  const logicalDigests = new Set(
    expectedKeys
      .map((key) => reportsByKey.get(key)?.normalizedLogicalSha256)
