// Generate src/render/unicode-font-routing.generated.ts from the
// /tmp/unicode-fonts.json sweep. For each unicode block (filename-derived
...
const data = JSON.parse(readFileSync("/tmp/unicode-fonts.json", "utf-8"));
...
out += "// Source data: /tmp/unicode-fonts.json (produced by tools/probe-983-sweep.mjs).\n";
...
writeFileSync("src/render/unicode-font-routing.generated.ts", out);
