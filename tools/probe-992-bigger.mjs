...
async function zoom(s, d) {
  ...
  await sharp(s)
    .resize(mm.width * 2, mm.height * 2, { kernel: "nearest" })
    .toFile(d);
}
...
await sharp({
  create: { width: w * 2 * 3 + 30, height: h * 2 + 20, channels: 3, background: { r: 255, g: 255, b: 255 } },
})
  .composite([
    { input: "/tmp/p992-big-ez.png", left: 5, top: 10 },
    { input: "/tmp/p992-big-az.png", left: w * 2 + 15, top: 10 },
    { input: "/tmp/p992-big-dz.png", left: w * 2 * 2 + 25, top: 10 },
  ])
