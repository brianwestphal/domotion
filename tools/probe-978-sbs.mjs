...
await sharp({
  create: { width: w * 4 * 3 + 30, height: h * 4 + 20, channels: 3, background: { r: 255, g: 255, b: 255 } },
})
  .composite([
    { input: "/tmp/p978-ez.png", left: 5, top: 10 },
    { input: "/tmp/p978-az.png", left: w * 4 + 15, top: 10 },
    { input: "/tmp/p978-dz.png", left: w * 4 * 2 + 25, top: 10 },
  ])
