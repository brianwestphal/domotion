...
await sharp({
  create: { width: w * 5 * 3 + 30, height: h * 5 + 20, channels: 3, background: { r: 255, g: 255, b: 255 } },
})
  .composite([
    { input: "/tmp/p980-ez.png", left: 5, top: 10 },
    { input: "/tmp/p980-az.png", left: w * 5 + 15, top: 10 },
    { input: "/tmp/p980-dz.png", left: w * 5 * 2 + 25, top: 10 },
  ])
