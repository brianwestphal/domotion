...
await page.setContent(
  `<html><body style="margin:0;padding:0;background:#fff"><div style="font-size:48px;font-family:'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',emoji;width:200px;height:80px">😀</div></body></html>`,
);
