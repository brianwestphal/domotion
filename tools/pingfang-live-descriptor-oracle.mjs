...
const runSwift = (repeats) =>
  JSON.parse(execFileSync("swift", [swift, String(repeats)], { encoding: "utf8", maxBuffer: 64 * 1024 * 1024 }));
...
const artifact = {
  ...
  environment: {
    ...
    fontInventoryDigest: createHash("sha256").update(inventory).digest("hex"),
  },
  codepoints: cps,
  coldProcesses: cold,
  warmProcess: warm,
