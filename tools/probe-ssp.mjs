...
const url =
  "file://" + resolve("/Users/westphal/Documents/domotion/external/html-test/20-deep-font-feature-values.html");
...
const info = await page.evaluate(() => {
  ...
  probe.style.cssText =
    "position:absolute;visibility:hidden;left:-9999px;font-family:" + cs.fontFamily + ";font-size:18px";
  ...
  timesProbe.style.cssText =
    'position:absolute;visibility:hidden;left:-9999px;font-family:Times,"Times New Roman",serif;font-size:18px';
  ...
  georgiaProbe.style.cssText =
    "position:absolute;visibility:hidden;left:-9999px;font-family:Georgia,serif;font-size:18px";
  ...
  sspProbe.style.cssText =
    'position:absolute;visibility:hidden;left:-9999px;font-family:"Source Serif Pro";font-size:18px';
